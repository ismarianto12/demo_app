...
class Menu_app
{
    ...
    ';
        $menu .=  self::menu_single(route('tmcabang.index'), '<i class="fas fa-list"></i>', 'Cabang');
        $menu .=  self::menu_single(route('tmlayanan.index'), '<i class="fas fa-list"></i>', 'Layanan Foto');
        $menu .=  self::menu_single(route('tmlog_access.index'), '<i class="fas fa-copy"></i>', 'Log access System');
        $menu .=  self::menu_single(route('tmpaketharga.index'), '<i class="fas fa-copy"></i>', 'Paket harga');
        $menu .=  self::menu_single(route('tmpemesanan.index'), '<i class="fas fa-chevron-right"></i>', 'Pemesanan Costumer');
        $menu .=  self::menu_single(route('tmuser_level.index'), '<i class="fa fa-user"></i>', 'Level Akses');
        $menu .=  self::menu_single(route('tmslide.index'), '<i class="fas fa-list"></i>', 'Slide');
        $menu .=  self::menu_single(route('trslide_category.index'), '<i class="fas fa-copy"></i>', 'Kategory Slide');
        $menu .=  self::menu_single(route('user.index'), '<i class="fas fa-copy"></i>', 'Master User Hak Akses');
        return $menu;
    }
}
